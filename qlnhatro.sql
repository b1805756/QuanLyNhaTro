...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 01, 2022 lúc 03:00 PM
...
INSERT INTO `hoadon` (`mahd`, `tenphong`, `csdien`, `csnuoc`, `thanhtien`) VALUES
(18, 2, 20, 20, 1670000),
(19, 8, 20, 20, 1390000),
(20, 9, 50, 50, 1530000),
(21, 8, 20, 20, 1410000),
...
(5, 1300000, 'Phòng mới, có gác, điện nước đầy đủ.', 1),
(6, 1300000, 'Phòng mới, có gác, điện nước đầy đủ.', 0),
...
('363256332', 'Nguyễn Trần Đại Phú', '1998-06-10', 'Phụng Hiệp, Hậu Giang.', '0923366233', 'Nam', 5, '2022-04-26', NULL),
...
('364192442', 'Lê Thị Mỹ Xuyên', '2003-03-22', 'Vĩnh Châu, Sóc Trăng.', '0392307133', 'Nữ', 9, '2021-08-17', NULL);
...
INSERT INTO `taikhoan` (`CCCD`, `MatKhau`, `tenphong`) VALUES
('354124974', '1', 8),
('363256332', '1', 5),
('364123102', '1', 2),
('364181231', '1', 1),
...
--
ALTER TABLE `taikhoan`
  ADD CONSTRAINT `taikhoan_ibfk_1` FOREIGN KEY (`CCCD`) REFERENCES `qlchothue` (`CCCD`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
